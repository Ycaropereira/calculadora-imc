  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10">
      ...
      <p className="mt-3 text-zinc-700 leading-relaxed">
        Esta calculadora tem finalidade informativa e educacional. O IMC é um indicador
        geral e não substitui avaliação profissional.
      </p>
      ...
      <p className="mt-3 text-zinc-700 leading-relaxed">
        ...
        site. Para orientações personalizadas, procure um profissional de saúde.
      </p>
